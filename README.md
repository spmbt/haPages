...
<blockquote> Замечание для пользователей <b><i>Firefox 30</b></i> и <b><i>Scriptish</b></i>: нужно использовать <a href=https://github.com/scriptish/scriptish-nightlies/tags>последнюю ночную сборку от 11 мая или около того, 0.1.12 и новее</a> Scriptish для корректных результатов (иначе, проблемы - с функциями GM_*** - и не работает список настроек для Fx30, а за ним многое другое).</blockquote>
	...
	<tr>
		...
		<td>Автоматизация сайта (>60 функций с настройками) с подключаемыми <a href=http://userstyles.org/styles/36690/>стилями ZenComment</a>.
				<li>&bull; <b>Подгрузка статей</b> без перезагрузки ленты</li>
				<li>&bull; <b>просмотр картинок</b> с увеличением и перемещением</li>
				<li>&bull; <b>принудительный кат</b>: все аннотации - не более определённой высоты</li>
				<li>&bull; <b>краткие даты</b>, адаптивно уменьшаемые заголовки</li>
				<li>&bull; <b>фильтр</b> по авторам и хабам</li>
				<li>&bull; <b>расцветка</b> комментаторов по активности</li>
				<li>&bull; <b>примерные даты</b> публикации по номеру в URL, и т.д.</li>
		</td>
		<td>
			<ul>
...
<blockquote> С 30 мая 2014 года новые версии HabrAjax и других скриптов, относящихся к Хабру, стали размещаться на <a href=https://github.com/spmbt/haPages/tree/gh-pages>github.com/spmbt/haPages</a> из-за невозможности обновления версий на прежнем традиционнном хостинге.</blockquote>
	...
	<tr>
		...
		<td>Переоформление сайта для <ul>
			...
			Основное:
				<li>&bull; незаметное Geektimes-меню: показ по наведению</li>
				<li>&bull; пара кнопок меню по углам вместо левой кнопочной панели</li>
				<li>&bull; уменьшены: заголовки, межстрочный интервал, поля, зазоры, сайдбар, футер</li>
				<li>&bull; невидимые аватары, кнопки отправки ответов и деакцентирование малозначимых полей</li>
				<li>&bull; нумерация страниц (пагинатор) фиксирована внизу окна</li>
		</td>
		<td>
			<ul>
	...
	<tr>
		...
		<td>Тёмная тема Хабрахабра. Дизайн, в основном, исходный, кроме тонов.
				<li>&bull; <b>Приглушенные цвета</b> картинок и блоков сайдбара<br>
				<li>&bull; незаметное Geektimes-меню: показ по наведению</li>
				<li>&bull; <b>Кнопки левой панели совмещены</b> с навигацией страниц</li>
				<li>&bull; Поддержка страниц "<b>мобильной версии</b>"</li>
				<li>&bull; Постоянно видимые подменю для широких страниц</li>
				<li>&bull; Исправление ошибок сайта</li>
				<li>&bull; <b>Рост иконок вдвое</b> по наведению мыши на заголовок ответа</li>
				<li>&bull; Некоторые аналогии с ZenComment: компактный футер, деакцентирование элементов в комментариях</li>
		</td>
		<td>
			<ul>
