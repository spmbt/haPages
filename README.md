_Для просмотра файлов и актуального описания перейдите в ветку пр-pages, можно по этой ссылке: https://github.com/spmbt/haPages/tree/gh-pages._
...
(*обратите внимание*, что ссылки на установку со страниц описания на userscripts.org - УСТАРЕВШИЕ и не могут быть там обновлены. **Устанавливать - с Github или greasyfork.org.**)

* [HabrPercentageRing](https://greasyfork.org/ru/scripts/1966-habr-percentage-ring): [===== установить, от 2014-11-02 =====](http://spmbt.github.io/haPages/userscript/habrPercentageRing/habrPercentageRing.user.js). 
...
* **Новое:**: юзерстили [HabraDarkAge](http://spmbt.github.io/haPages/doc/habraDarkAge/); [===== установить =====](http://spmbt.github.io/haPages/userscript/habraDarkAge/habraDarkAge.user.css) ([описание на хостинге стилей](https://userstyles.org/styles/101697/)), [вводная статья на Хабре](http://habrahabr.ru/post/242189/).
